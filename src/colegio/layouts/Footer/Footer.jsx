...
import {
  insignia, ubicacionIcon,
  telefonoIcon,
  cartaIcon,
  gatoIcon,
  tresEstrellasIcon
} from '../../assets/iconos'
import { RedSocial, WavesTop } from '../../components'
...
export const Footer = () => {
  ...
  return (
    <footer>
      {pathname === '/inicial' || pathname === '/metodologia'
        ? <WavesTop color='yellow' />
        : <WavesTop />}
      <div className='informacionFooter'>
        ...
        <ul className='tresEstrellasIcon'>
          <img src={tresEstrellasIcon} alt='icono de estrella' />
        </ul>
      </div>
      <div className='derechos'>
        ...
        © 2024 Gabino Cisneros Alexis. Todos los derechos reservados
      </div>
    </footer>
  )
}
